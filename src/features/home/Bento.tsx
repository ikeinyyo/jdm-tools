    ...
    <div className="grid grid-cols-6 grid-rows-5 gap-2 h-120 w-4xl">
      {links.map(
        ({ url, label, colSpan, rowSpan, colStart, rowStart, bg }, index) => (
          <div
            key={index}
            className={`flex justify-center items-center ${bg} ${colSpan} ${rowSpan} ${
              colStart || ""
            } ${rowStart || ""}`}
          >
            <WebPageLink
      ...
      <div className="col-start-5 row-start-5 col-span-2 bg-dark flex justify-center items-center">
        <WebPageLink
